...
// OpenZeppelin Contracts (last updated v4.5.0) (token/HRC20/HRC20.sol)
 ...
 */
contract HRC20 is Context, IERC20, IERC20Metadata {
    ...
    function _transfer(
        ...
        require(fromBalance >= amount, "HRC20: transfer amount exceeds balance");
        unchecked {
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        require(accountBalance >= amount, "HRC20: burn amount exceeds balance");
        unchecked {
    ...
    function _spendAllowance(
        ...
        if (currentAllowance != type(uint256).max) {
            require(currentAllowance >= amount, "HRC20: insufficient allowance");
            unchecked {
